...
_PREDEFINED_SPLITS_COCO_PANOPTIC_CAPTION = {
    ...
    #     "coco/annotations/refcocog_umd_train.dict", # annot_root
    # ),
    # "refcocog_val_google": (
    #     "coco/train2017", # image_root
    #     "coco/annotations/refcocog_google.dict", # annot_root
    # ),
    # "refcocop_val_unc": (
    #     "coco/train2017", # image_root
    #     "coco/annotations/refcocop_unc.dict", # annot_root
    # ),
    # "refcoco_val_unc": (
    #     "coco/train2017", # image_root
    #     "coco/annotations/refcoco_unc.dict", # annot_root
    # ),
    "refcocog_val_umd": (
        "coco/train2017", # image_root
        "coco/annotations/refcocog_umd_val.dict", # annot_root
    ),
}
