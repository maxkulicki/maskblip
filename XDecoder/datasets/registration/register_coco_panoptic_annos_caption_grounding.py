...
_PREDEFINED_SPLITS_COCO_PANOPTIC_CAPTION = {
    "coco_2017_train_panoptic": (
        ...
        "coco/annotations/panoptic_train2017.dict",
        "coco/panoptic_semseg_train2017",
        "coco/annotations/captions_train2017.dict",
        "coco/annotations/grounding_train2017.dict",
        "coco/annotations/caption_class_similarity.pth"
    ),
    "coco_2017_train_panoptic_filtkar": (
        # This is the original panoptic annotation directory
        "coco/panoptic_train2017",
        "coco/annotations/panoptic_train2017_filtkar.dict",
        "coco/panoptic_semseg_train2017",
        "coco/annotations/captions_train2017_filtkar.dict",
        "coco/annotations/grounding_train2017.dict",
        "coco/annotations/caption_class_similarity.pth"
    ),
    "coco_2017_train_panoptic_filtrefgumdval": (
        # This is the original panoptic annotation directory
        "coco/panoptic_train2017",
        "coco/annotations/panoptic_train2017_filtrefgumdval.dict",
        "coco/panoptic_semseg_train2017",
        "coco/annotations/captions_train2017_filtrefgumdval.dict",
        "coco/annotations/grounding_train2017_filtrefgumd.dict",
        "coco/annotations/caption_class_similarity.pth"
    ),
    "coco_2017_train_panoptic_filtall": (
        # This is the original panoptic annotation directory
        "coco/panoptic_train2017",
        "coco/annotations/panoptic_train2017_filtrefgumdval_filtvlp.dict",
        "coco/panoptic_semseg_train2017",
        "coco/annotations/captions_train2017_filtrefgumdval_filtvlp.dict",
        "coco/annotations/grounding_train2017_filtrefgumdval_filtvlp.dict",
        "coco/annotations/caption_class_similarity.pth"
    ),
}
...
def load_coco_panoptic_json(json_file, image_dir, gt_dir, semseg_dir, caption_file, grounding_file, meta):
    ...
    Args:
        ...
        json_file (str): path to the dict file. e.g., "~/coco/annotations/panoptic_train2017.dict".
    Returns:
