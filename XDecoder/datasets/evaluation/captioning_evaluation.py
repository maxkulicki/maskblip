...
class CaptioningEvaluator(DatasetEvaluator):
    ...
    def __init__(
        ...
        Args:
            ...
            output_dir (str): optional, an output directory to dump all
                ...
                2. "coco_instances_results.dict" a dict file in COCO's result format.
            ...
            allow_cached_coco (bool): Whether to use cached coco dict from previous validation
    ...
    def evaluate(self, img_ids=None):
        ...
        pred_pth = os.path.join(self._output_dir, 'results.dict')
