...
coco_train_annot = json.load(open(os.path.join(coco_root, 'annotations/instances_train2017.dict')))
coco_train_id = []
image_annot = {}
...
json.dump(outputs, open(os.path.join(coco_root, 'annotations/refcocog_umd_train.dict'), 'w'))
